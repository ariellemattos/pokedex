class Specie {
  ...
  List<pokedex_youtubeNumbers> pokedex_youtubeNumbers;
  ObjPokemon shape;
  ...
  Specie.fromJson(Map<String, dynamic> json) {
    ...
    if (json['pokedex_youtube_numbers'] != null) {
      pokedex_youtubeNumbers = new List<pokedex_youtubeNumbers>();
      json['pokedex_youtube_numbers'].forEach((v) {
        pokedex_youtubeNumbers.add(new pokedex_youtubeNumbers.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.pokedex_youtubeNumbers != null) {
      data['pokedex_youtube_numbers'] =
          this.pokedex_youtubeNumbers.map((v) => v.toJson()).toList();
    }
    if (this.shape != null) {
...
class pokedex_youtubeNumbers {
  int entryNumber;
  ObjPokemon pokedex_youtube;

  pokedex_youtubeNumbers({this.entryNumber, this.pokedex_youtube});

  pokedex_youtubeNumbers.fromJson(Map<String, dynamic> json) {
    entryNumber = json['entry_number'];
    pokedex_youtube =
        json['pokedex_youtube'] != null ? new ObjPokemon.fromJson(json['pokedex_youtube']) : null;
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['entry_number'] = this.entryNumber;
    if (this.pokedex_youtube != null) {
      data['pokedex_youtube'] = this.pokedex_youtube.toJson();
    }
    return data;
  }
}
